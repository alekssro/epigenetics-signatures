...
outputVfile <- 1 #args[5] # "results/genomic_survey/A549/V_matrix.csv"
totMappedAllExpFile <- 2 #args[6]  # "results/genomic_survey/A549/CTCF/A549_CTCF_allExp_totals.txt" # 
