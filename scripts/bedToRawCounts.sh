...
for CELL_LINE in "${CELL_LINES[@]}";do
    ...
    for SIGNAL_TRACK in "${SIGNAL_TRACKS[@]}";do
        ...
        Rscript ${SCRIPT_DIR}/bedCountsToV.R ${ANALYSIS_DIR}/input_data_files.txt ${DATASHEET_SAMPLES_FILE} ${BINNED_GENOME} ${MAPPABILITY_TRACK} ${ANALYSIS_DIR}/${CELL_LINE}/V_matrix.csv ${OUT_DIR}/${CELL_LINE}_${SIGNAL_TRACK}_allExp_totals.txt ${OUT_DIR}/${SAMPLE_ID}.intersect.bed
