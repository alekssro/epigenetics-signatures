...
\captionsetup{font=footnotesize, width=0.9\textwidth}
\usepackage{cite}
\usepackage{rotating}
...
\begin{figure}[h]
\centering
\includegraphics[width=6cm]{Figures/AU_seal.png}\label{fig:AU_seal}
...
\deptname\
\groupname\
\vspace{1cm} % Research group name and department name
...
\textbf{ChIP-seq} & Chromatin Inmunoprecipitation next-generation sequencing\\
\textbf{CpG} & Cytosine followed by a Guanine\\
\textbf{CSV} & Comma-Separated Values\\
\textbf{DBN} & Dynamic Bayerian Network\\
\textbf{DNA} & DescriptionDeoxyribonucleic acid\\
\textbf{DNMTs} & DNA MethylTransferases\\
\textbf{HDACs} & Histone deacetylases\\
\textbf{HMM} & Hidden Markov Model\\
\textbf{NGS} & Next-Generation Sequencing\\
\textbf{NMF} & Non-Negative Matrix Factorization\\
\textbf{PCA} & Principal Component Analysis\\
\textbf{PTGS} & Post-transcriptional gene silencing\\
\textbf{RNA} & Ribonucleic acid\\
\textbf{RSS} & Residual Sum of Squares\\
\textbf{TFs} & Transcription Factors\\
\textbf{TGS} & Transcriptional Gene Silencing\\
\textbf{TSS} & Transcription Start Sites\\
\textbf{VQ} & Vector Quantization\\
\textbf{WGBS} & Whole-Genome Bisulfite Sequencing\\
